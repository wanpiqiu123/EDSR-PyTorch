...
python main.py --model EDSR --scale 2 --save edsr_x2 --n_resblocks 16 --n_feats 256 --res_scale 0.1 --reset --ext sep --n_GPUs 2 --save_gt

# SCGSR
python main.py --model SGCSR --scale 2 --save sgcsr_x2 --n_resblocks 16 --n_feats 256 --res_scale 0.1 --reset --ext sep --n_GPUs 2 --save_gt

python main.py --model SGCSR --scale 2 --save sgcsr_x2_no_sgc --n_resblocks 16 --n_feats 256 --res_scale 0.1 --reset --ext sep --n_GPUs 2 --save_gt

# Test
python main.py --data_test Set5 --scale 2 --load edsr_x2 --n_resblocks 16 --n_feats 256 --res_scale 0.1 --test_only --save_results --save_gt

python main.py --data_test Set5 --load sgcsr_x2 --pre_train ../experiment/sgcsr_x2/model/model_latest.pt --scale 2 --n_resblocks 16 --n_feats 256 --res_scale 0.1 --test_only --save_results --save_gt


# EDSR in the paper (x2)
# python main.py --model EDSR --scale 2 --save edsr_x2 --n_resblocks 16 --n_feats 256 --res_scale 0.1 --reset --ext sep
